...
.. code::
   ...
   det deploy gcp up --cluster-id CLUSTER_ID --project-id PROJECT_ID \
      ...
      --gpu-env-image determinedai/environments-dev:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.30.1 \
      --cpu-env-image determinedai/environments-dev:py-3.9-pytorch-1.12-tf-2.11-cpu-0.30.1
