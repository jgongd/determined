...
+=============+===============================================================================+
| CPUs        | ``determinedai/environments-dev:py-3.9-pytorch-1.12-tf-2.11-cpu-0.30.1``          |
+-------------+-------------------------------------------------------------------------------+
| NVIDIA GPUs | ``determinedai/environments-dev:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.30.1``       |
+-------------+-------------------------------------------------------------------------------+
...
.. code:: bash
   ...
   # Determined Image
   FROM determinedai/environments-dev:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.30.1
...
.. code:: bash
   ...
   # Determined Image
   FROM determinedai/environments-dev:py-3.9-pytorch-1.12-tf-2.11-cpu-0.30.1
